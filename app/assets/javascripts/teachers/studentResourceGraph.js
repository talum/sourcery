...
function buildResourceChart (arrayOfStudentHashes){    
  ...
  var bar = chart.selectAll("g")
                 ...
                 .attr("transform", function(data, index){
                  return "translate(" + (index * (barWidth) + margin.left) + "," + (chartHeight - chartScale(data.resource_count)) + ")"
                 })
                 .attr("fill", "steelblue")
  ...
  bar.append("rect")
     ...
     .attr("height", function(d) {
      // debugger;
      return chartScale(d.resource_count)
     })
  ...
  bar.append("text")
     ...
     .attr("fill", "white")
     .text(function(d) {return d.resource_count;});
